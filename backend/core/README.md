...
### Embedded development runtime

- Build and run the embedded jar:
  - `mvn package`
  - `java -jar target/core-1.0.0-SNAPSHOT-embedded.jar`
- Useful endpoints:
  - Swagger UI: `http://localhost:8080/swagger`
  - Fallback OpenAPI JSON: `http://localhost:8080/openapi`

### Open Liberty runtime

- Start Open Liberty in dev mode:
  - `mvn liberty:run`
- Useful endpoints:
  - REST API base: `http://localhost:9081/core/api`
  - MicroProfile OpenAPI: `http://localhost:9081/openapi/`
  - OpenAPI UI: `http://localhost:9081/openapi/ui/`
  - MicroProfile Health: `http://localhost:9081/health`
  - MicroProfile Metrics: `https://localhost:9444/metrics`
